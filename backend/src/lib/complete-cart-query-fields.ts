/**
 * Graph fields for cart query when converting cart → order.
 * Keep aligned with @medusajs/core-flows `completeCartFields` (patched dist in this repo).
 */
export const completeCartQueryFields = [
  "metadata",
  "id",
  "currency_code",
  "email",
